export const speakers = [
  ...
  },
  {
    ...
    biography:
      "Mya is a former middle school teacher who recently moved back to Indy from New Orleans. She has a Bachelors in Health Sciences with a concentration in Exercise Science. Mya came into tech through attending Kenzie Academy and she currently works as a UX Engineer at Crafted LLC. In her spare time, she enjoys attending local meetups and exploring the city with her dog, Georgie!",
    pronouns: "she/her/hers",
    picture: "mya-williams.jpg",
  },
  {
    name: "Caryssa Perez",
    contact: {
  ...
  },
  {
    ...
    biography:
      "Eli’s passions lie in Philosophy, collaborative creativity, and honesty. Eli has been in the Social Media and Marketing space since highschool and he even worked for Chick-fil-a's Marketing Dept. (during the original scandal, btw). He also loves to brainstorm and help activate genius ideas.",
    pronouns: "he/him/his",
    picture: "eli-vida.jpg",
  },
  {
    name: "Tonie Snell",
    contact: {
  ...
  },
  {
    ...
    biography:
      "Ashlee just finished her Software Engineering degree and is working her second full-time job in software. Ashlee’s primary focus as a Front-End Web Developer is to make the internet a valuable experience for everyone. Accessibility isn't something to consider-it's absolutely necessary.",
    pronouns: "she/her/hers",
    picture: "ashlee-boyer.jpeg",
  },
  {
    name: "Linda Calvin",
    contact: {
